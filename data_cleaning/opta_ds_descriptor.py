...
opta_data_path = os.path.join(settings.data_folder_path, 'opta_ds')
...
combined_data.to_csv(os.path.join(settings.data_folder_path, opta_combined_file), index=False)

#%%
# Read combined Opta dataset
opta_dataset_file = os.path.join(settings.data_folder_path, opta_combined_file)
