...
soccerlogs_error_vars = ['Goals_from_set_play', 'Yellow_card']
soccerlogs_specific_vars = [
    'Clearance_lost',
    'Red_card'
]
...
opta_female_df.drop(columns=['Fouls'], inplace=True)
opta_female_df.rename(columns={'_period_id': 'matchPeriod', 'Fouls_won': 'Fouls_received', 'Clearance_won': 'Clearances'}, inplace=True)
soccerlogs_male_data_df.rename(columns={'Fouls': 'Fouls_received', 'Clearance_won': 'Clearances'}, inplace=True)
